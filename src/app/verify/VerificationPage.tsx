...
const VerificationPage = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      console.log(
        'Sending verification request with passages:',
        ...
        {!passages.length ? (
                  ...
                  {file ? (
                    ...
                    <>
                      ...
                      <p className="text-gray-500 text-sm mt-1">
                        Choose a .docx file (10-30 pages)
                      </p>
                    </>
                  )}
                </div>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-24 h-24 mb-4 relative">
                      <svg className="animate-book-open" viewBox="0 0 100 100">
                        ...
                        />
                        <path
                          d="M20,30 L20,80 Q20,85 25,85 L50,85 L50,30 Z"
                          fill="#B54646"
                        />
                        <path
                          d="M80,30 L80,80 Q80,85 75,85 L50,85 L50,30 Z"
                          fill="#5EA89B"
                        />
                      </svg>
                    </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              We've selected 3 random passages from your document. Click "Verify
              with Tandem" to test if our AI can identify their page numbers.
            </p>
            ...
            <div className="mb-6">
              ...
              {!documentPageCount && (
                <p className="text-gray-500 text-sm mt-1">
                  This helps Tandem accurately identify page numbers
                </p>
              )}
            </div>
                ...
                >
                  ...
                  <div className="flex justify-between mt-2">
                    <p className="text-gray-600">
                      Page Number: {result.pageNumber || 'Not provided'}
                    </p>
                    <p
                ...
                <>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-green-600 mt-1">
                      Tandem can confidently identify page locations in your
                      document.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      Please check these page numbers against your document. Are
                      they accurate?
                    </p>
                  </div>
                ...
                <>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-yellow-600 mt-1">
                      Tandem has low confidence in some page numbers. This may
                      affect the quality of your index.
                    </p>
                  </div>
                  <button
                    onClick={() => window.location.reload()}
